...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculateChange(String currentValue) {
        ...
        if(num >=500) {
//            String fiveHundred = String.valueOf((int) Math.floor(num/500));
        ...
        if (num >=100) {
//            String oneHundred = String.valueOf((int) Math.floor(num/100));
        ...
        if (num >= 50) {
//            String fifty = String.valueOf((int) Math.floor(num/50));
            int fifty = num / 50;
            num %= 50;
        ...
        if (num >= 20) {
//            String twenty = String.valueOf((int) Math.floor(num/20));
            int twenty = num / 20;
            num = num % 20;
        ...
        if (num >= 10) {
//            String ten = String.valueOf((int) Math.floor(num/10));
            int ten = num / 10;
            num = num % 10;
        ...
        if (num >=5 ) {
//            String five= String.valueOf((int) Math.floor(num/5));
            int five = num / 5;
            num = num % 5 ;
        ...
        if (num >= 2) {
//            String two = String.valueOf((int) Math.floor(num/2));
            int two = num / 2;
            num = num % 2;
        ...
        if (num >= 1) {
//            String one = String.valueOf((int) Math.floor(num/1));
            int one = num / 1;
